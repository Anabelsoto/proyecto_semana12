        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <table class="table text-center"><!--Creamos una tabla que mostrará todas las tareas-->
                        ...
                        <tbody>
                            <tr v-for="task in arrayTasks" :key="task.idpaciente"> <!--Recorremos el array y cargamos nuestra tabla-->
...
<script>
    export default {
        ...
        methods:{
            getTasks(){
                let me =this;
                let url = '/tareasp' //Ruta que hemos creado para que nos devuelva todas las tareasp
            ...
            saveTasks(){
                let me =this;
                let url = '/tareasp/guardar' //Ruta que hemos creado para enviar una tarea y guardarla
            ...
            loadFieldsUpdate(data){ //Esta función rellena los campos y la variable update, con la tarea que queremos modificar
                ...
                let me =this;
                let url = '/tareasp/buscar?idpaciente='+this.update;
                axios.get(url).then(function (response) {
            ...
            deleteTask(data){//Esta nos abrirá un alert de javascript y si aceptamos borrará la tarea que hemos elegidclienteo
                ...
                if (confirm('¿Seguro que deseas borrar esta tarea?')) {
                    axios.delete('/tareasp/borrar/'+task_id
                    ).then(function (response) {
                        me.getTasks();
                    })
                    .catch(function (error) {
